...
public class TesteClasseAnonima {
	public static void main(String[] args) {
        ...
        // Function Object (objeto apenas com um processamento)
        lista.sort(new Comparator<Conta> () { //Classe anonima, implementa a interface Comparator com um UNICO método 
